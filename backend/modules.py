...
from .constants import CACHE_DIR, CSV_FOLDER, Absolute_path
...
def read_and_display_image_pil(image_path):
    # 读取图像
...
def get_prediction(
    ...
    if segmentation:
        ...
        output_path = os.path.join(Absolute_path, output_path)
    ...
    # draw result
    output_path = draw_image(output_path, ori_img, result_dict, class_names)
